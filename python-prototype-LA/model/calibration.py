...
@jaxtyped(typechecker=beartype)
def build_extrinsic_matrix(rotation_matrix: Float[np.ndarray, "3 3"], position: Float[np.ndarray, "3 1"]) -> Float[np.ndarray, "4 4"]:
    """
    ...
    extrinsic_matrix[:3, 3] = translation.ravel()  # perform R | t
